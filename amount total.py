...
class RestaurantOrderManagement:
    def __init__(self, root):
        root.title("Restaurant Management App")  # Set the title of the window
...
class RestaurantOrderManagement:
    def __init__(self, root):
        ...
        currency_dropdown = ttk.Combobox('frame', textvariable=self.currency_var, state="readonly", width=10)
...
def place_order(self):
    ...
    if total_cost > 0:
        ...
        messagebox.showerror("Please order at least one item.")
